...
public class aliyunMsg2LMTDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		//替换成你的AK
		final String accessKeyId = "LTAIUwEYGHw49IRQ";//你的accessKeyId,参考本文档步骤2
		...
		IAcsClient acsClient = new DefaultAcsClient(profile);
		 ...
		 request.setPhoneNumbers("15855891980");//13916805133
		 //必填:短信签名-可在短信控制台中找到
		 request.setSignName("罗美特平台");
		 //必填:短信模板-可在短信控制台中找到 -SMS_105980105      -SMS_142947036
		 request.setTemplateCode("SMS_142947036");//您的校验码：${code}，您正在绑定手机号，成为罗美特平台会员，感谢您的支持！
