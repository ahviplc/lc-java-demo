package com.mail;
/**   
 * 简单邮件（不带附件的邮件）发送器   -端口465-ssl--好使-已测试
 */ 
  ...
  */    
    ...
    public static void main(String[] args) throws Exception{   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setPassword("lc201088");//您的邮箱密码    
	     mailInfo.setFromAddress("ahviplc@163.com");    
	     mailInfo.setToAddress("ahlc@sina.cn");    
	     mailInfo.setSubject("设置邮箱标题-2017年9月11日15:45:48");    
	     mailInfo.setContent("设置邮箱内容-2017年9月11日15:45:54！~LC");    
	     //这个类主要来发送邮件   
	  
	     SimpleMailSender sms = new SimpleMailSender();   
	     sms.sendTextMail(mailInfo);//发送文体格式    
	     //sms.sendHtmlMail(mailInfo);//发送html格式   
	     System.out.println("成功！465");
